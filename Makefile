...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Mar 22 23:59:03 2015
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/trab1comp1.0.0/ && $(COPY_FILE) --parents mainwindow.h displayfileobject.h coordinate.h geometricobject.h qviewport.h window.h .tmp/trab1comp1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp displayfileobject.cpp coordinate.cpp qviewport.cpp window.cpp .tmp/trab1comp1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/trab1comp1.0.0/ && (cd `dirname .tmp/trab1comp1.0.0` && $(TAR) trab1comp1.0.0.tar trab1comp1.0.0 && $(COMPRESS) trab1comp1.0.0.tar) && $(MOVE) `dirname .tmp/trab1comp1.0.0`/trab1comp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/trab1comp1.0.0
